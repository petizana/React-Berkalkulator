...
export default function MarriageDiscount({style, updateSelectedMember, selectedMember }) {
    ...
    return (
        <div style={style}>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <label htmlFor="start"><strong>Add meg a házasságkötés dátumát</strong></label>
                        <br />
            ...
            <Eligibility eligible={selectedMember.marriage}></Eligibility>
        </div>
    )
}